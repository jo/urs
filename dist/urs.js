...
(function(exports) {
  ...
  function createStyle(options) {
    ...
    style.innerHTML = '#' + options.element.id + ' .urs-panel { width: ' + 200 * options.panelSize + '%; }\n' +
      ...
      '  -webkit-transition: -webkit-transform ' + options.animationDuration + 'ms ' + options.timingFunction + ';\n' +
      '  -moz-transition: -moz-transform ' + options.animationDuration + 'ms ' + options.timingFunction + ';\n' +
      '  -o-transition: -o-transform ' + options.animationDuration + 'ms ' + options.timingFunction + ';\n' +
      '  transition: transform ' + options.animationDuration + 'ms ' + options.timingFunction + ';\n' +
      '}';
  }
  ...
  function onSlideStart(options, e) {
    ...
    options.panel.panel.className = 'urs-panel';
  ...
  exports.urs = function(options) {
    ...
    options.timingFunction = options.timingFunction || 'ease-out';
